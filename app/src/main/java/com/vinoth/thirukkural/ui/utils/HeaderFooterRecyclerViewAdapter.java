package com.vinoth.thirukkural.ui.utils;
...
public abstract class HeaderFooterRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType >= HEADER_VIEW_TYPE_OFFSET && viewType < HEADER_VIEW_TYPE_OFFSET + VIEW_TYPE_MAX_COUNT) {
            ...
            throw new IllegalStateException("invaild viewType");
        }
    }
    ...
    /**
     * This method works exactly the same as {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int)}, but for header items.
     *
    ...
    /**
     * This method works exactly the same as {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int)}, but for footer items.
     *
    ...
    /**
     * This method works exactly the same as {@link #onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder, int)}, but for content items.
     *
