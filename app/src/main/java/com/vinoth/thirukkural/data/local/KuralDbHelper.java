...
public class KuralDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sectionTB);
        String sql = "CREATE TABLE " + QUA + DBContract.KuralContract.TABLE_NAME + QUA + " ( " + QUA + DBContract.KuralContract.ID + QUA + " INTEGER NOT NULL, " + QUA + DBContract.KuralContract.CHAPTER_ID + QUA + " INTEGER NOT NULL, " + QUA + DBContract.KuralContract.TAMIL + QUA + " TEXT, " + QUA + DBContract.KuralContract.ENGLISH + QUA + " TEXT, " + QUA + DBContract.KuralContract.TRANSLITERATION + QUA + " TEXT, " + QUA + DBContract.KuralContract.MV_EXP + QUA + " TEXT, " + QUA + DBContract.KuralContract.SP_EXP + QUA + " TEXT," + QUA + DBContract.KuralContract.MK_EXP + QUA + " TEXT, " + QUA + DBContract.KuralContract.COUPLET + QUA + " TEXT, " + QUA + DBContract.KuralContract.ENG_EXP + QUA + " TEXT, PRIMARY KEY(" + QUA + DBContract.KuralContract.ID + QUA + ") )";
        db.execSQL(sql);
